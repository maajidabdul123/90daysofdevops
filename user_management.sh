...
function UserAccountManagement {
        ...
        if [ "$1" == "-c" ] || [ "$1" == "--create" ];then
                read -p "Enter username which you want To Create: " username
        ...
        ###Account Deletion
                ...
                if [ $userValidation -gt 0 ];then
                        echo "User exists; Deleteing the user: $username With There Home Dir."
                        userdel -r $username
                else
        ...
        ###Password Reset
                ...
                read -p "Enter username for which the Password You Want To Reset: " username
                userValidation=$(cat /etc/passwd | grep $username | wc -l)
        ...
        ###Help Option
                ...
                echo "About => This is User Account Management script. Which you can use to Create,Delete,List and Reset the user password. Please see below mention option or user guide. "
